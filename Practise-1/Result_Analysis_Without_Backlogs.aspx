<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result_Analysis_Without_Backlogs.aspx.cs" Inherits="Practise_1.WebForm24" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <table style="width:100%;">
            ...
            <tr>
                <td colspan="3" align="center">
                    <asp:Label ID="Label75" runat="server" Text="Number of students who have successfully graduated without backlogs in any semester/year of study"></asp:Label>
                </td>
            </tr>
            <tr>
